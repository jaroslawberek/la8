...
@section('content')
    <div class="container">
        ...
        <a class="btn btn-primary"
           href="{{ route('person.create') }}">Nowy</a>
        <div class="card mt-3">
            <form id="people-list-form"
                  action="#"
                  method="get">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="table-limit">
                        <input type="text"
                               name="limit"
                               value="{{ $filter['limit'] ?? ($people->limit ?? '5') }}"
                               placeholder="ile wierszy"
                               form="people-list-form">/{{ $people->total() ?? '0' }}
                        >
                    </div>
                </div>
                <div class="card-body">
